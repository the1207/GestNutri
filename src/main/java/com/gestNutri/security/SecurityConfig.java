        ...
        http.cors(cors -> cors.configurationSource(corsConfigurationSource()))
            .csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .hasAnyRole("NUTRITIONNISTE", "ADMINISTRATEUR")
                        .requestMatchers("/api/formules/*/export/**")
                        .hasAnyRole("NUTRITIONNISTE", "OPERATEUR_ATELIER", "ADMINISTRATEUR")
                        .requestMatchers("/api/formules/**", "/api/lignes-formule/**", "/api/resultats-analyse/**")
                        .hasAnyRole("NUTRITIONNISTE", "OPERATEUR_ATELIER", "ADMINISTRATEUR")
